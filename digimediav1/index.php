          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="about-left-image  wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/about-dec.png" alt="">
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="contact-dec">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/images/contact-dec.png" alt="">
                </div>
              </div>
              <div class="col-lg-5">
                <div id="map">
